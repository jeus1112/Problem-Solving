...
//						}
//					}
//					maxemp = Math.max(maxemp, empty);
//					maxlike = Math.max(maxlike, likest);
//					que.offer(new seat(i, j, empty, likest));
//				}
//			}
//		}
//		int mcemp = Integer.MIN_VALUE;
//		Queue<seat> q1 = new LinkedList<>();
//		while(!que.isEmpty()) {
//			seat curr = que.peek();
//			int cr = curr.r;
//			int cc = curr.c;
...
//					continue;
//				}else {
//					mcemp = Math.max(mcemp, cemp);
//					q1.offer(new seat(cr, cc, cemp, clike));
//					que.poll();
//					continue;
//				}
//			}
